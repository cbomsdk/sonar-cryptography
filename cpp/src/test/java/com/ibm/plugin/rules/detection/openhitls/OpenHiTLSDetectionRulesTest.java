...
class OpenHiTLSDetectionRulesTest extends TestBase {
    ...
    @Test
    void test() {
        CxxVerifier.verify("rules/detection/openhitls/OpenHiTLSDetectionRulesTestFile.cpp", this);
        ...
        assertThat(values)
                .contains(
                        ...
                        "TLS-GROUPS:x25519",
                        "TLS-GROUPS:secp384r1,X25519MLKEM768",

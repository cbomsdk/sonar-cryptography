 ...
 */
package com.ibm.plugin.rules.detection.openhitls.signature;
...
/** Detection rules for openHiTLS EAL public-key signature algorithms. */
public final class OpenHiTLSSignature {

    private static final String BUNDLE = "openHiTLS";

    private static final IDetectionRule<AstNode> EAL_PKEY =
            signatureRule(0, "CRYPT_EAL_PkeyNewCtx");

    private static final IDetectionRule<AstNode> EAL_PROVIDER_PKEY =
            signatureRule(1, "CRYPT_EAL_ProviderPkeyNewCtx");

    private OpenHiTLSSignature() {
        // private
    }
    ...
    @Nonnull
    private static IDetectionRule<AstNode> signatureRule(int argumentIndex, String... methods) {
        return new DetectionRuleBuilder<AstNode>()
                ...
                .shouldBeDetectedAs(
                        new OpenHiTLSArgumentValueFactory(
                                argumentIndex, OpenHiTLSAlgorithmNames.SIGNATURES))
                .withAnyParameters()

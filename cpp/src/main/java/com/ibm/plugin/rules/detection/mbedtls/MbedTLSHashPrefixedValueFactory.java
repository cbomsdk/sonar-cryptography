...
public final class MbedTLSHashPrefixedValueFactory implements IActionFactory<AstNode> {

    private final int argumentIndex;
    @Nonnull private final String prefix;

    public MbedTLSHashPrefixedValueFactory(int argumentIndex, @Nonnull String prefix) {
    ...
    public Optional<IAction<AstNode>> apply(@Nonnull AstNode astNode) {
        return MbedTLSAstUtils.getLogicalArgument(astNode, argumentIndex)
                ...
                .map(hash -> new ValueAction<>(prefix + hash, astNode));
    }
}

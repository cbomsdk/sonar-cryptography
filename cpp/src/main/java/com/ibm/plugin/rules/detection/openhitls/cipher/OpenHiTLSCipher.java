...
/** Detection rules for openHiTLS EAL cipher APIs. */
public final class OpenHiTLSCipher {

    private static final String BUNDLE = "openHiTLS";

    private static final IDetectionRule<AstNode> EAL_CIPHER =
            cipherRule(0, "CRYPT_EAL_CipherNewCtx");

    private static final IDetectionRule<AstNode> EAL_PROVIDER_CIPHER =
            cipherRule(1, "CRYPT_EAL_ProviderCipherNewCtx");

    private OpenHiTLSCipher() {
        // private
    }

    @Nonnull
    public static List<IDetectionRule<AstNode>> rules() {
        return List.of(EAL_CIPHER, EAL_PROVIDER_CIPHER);
    }
        ...
        return new DetectionRuleBuilder<AstNode>()
                ...
                .shouldBeDetectedAs(
                        new OpenHiTLSArgumentValueFactory(
                                argumentIndex, OpenHiTLSAlgorithmNames.CIPHERS))
                .withAnyParameters()

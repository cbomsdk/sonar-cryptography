...
public final class MbedTLSTlsConfigurationAction implements TlsConfigurationAction {
    ...
    public MbedTLSTlsConfigurationAction(
    ...
    @Nullable public String tlsVersion() {
        return tlsVersion;
    }

...
public final class PycaCipherMapper implements IMapper {
    ...
    public @Nonnull Optional<? extends INode> parse(
        ...
        return switch (str.toUpperCase().trim()) {
            ...
            case "DES3", "3DES", "TRIPLEDES" -> Optional.of(new TripleDES(detectionLocation));
            case "CAST", "CAST5", "CAST128" -> Optional.of(new CAST128(detectionLocation));
            ...
            case "ARC2", "RC2" -> Optional.of(new RC2(detectionLocation));
